...
public class SwagLabsWebTest {
    ...
    public void checkInformation() throws InterruptedException, IOException {
        ...
        System.out.println("================================= Test 0011 ============================================\n");
        System.out.println("CHECK Information TEST CASE\n");

        System.out.println("----------Test Payment Information--------\n");
        ...
        //Print actual text
        System.out.println("Payment Information Actual text:" + actualText);

        if (expectedText.equals(actualText)) {
            System.out.println("Payment Information Test: PASS\n");
            System.out.println("SauceCard #31337 is Under the value of Payment Information Success \n");
        } else {
        ...
        //Print actual text
        System.out.println("Test Shipping Information Actual text:" + actualText);
